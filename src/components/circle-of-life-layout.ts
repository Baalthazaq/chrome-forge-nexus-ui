...
// Undead & Construct are now top-level Sources (their own wheels), not families.
// Modron remains nested under Construct but is hidden from active rolls.
const EXCLUDED_FAMILY_LABELS = new Set(["Modron"]);
